...
class AuditConsultationScreen extends StatelessWidget {
  ...
  buildAuditTestItem(AuditTest auditTest,BuildContext context,AcceptAuditConsultBloc myBloc){
    return Container(
      ...
      child: BlocBuilder<AcceptAuditConsultBloc, AcceptAuditConsultState>(
        bloc: myBloc..add(CheckConsultAcceptEvent(auditTestId: auditTest.id.toString())),
        builder: (context, state) {
