      ...
      return BlocBuilder<TestBloc, TestState>(
          builder: (context, state) {
            ...
            if (state is LoadedTestState) {
              ...
              if(state.testEntity.questionKy!=null && state.testEntity.questionEn!=null){
                ...
                question = lan == ''
                    ? state.testEntity.question!
                    : lan == 'en'
                    ? (state.testEntity.questionEn ?? state.testEntity.question!)
                    : (state.testEntity.questionKy ?? state.testEntity.question!);
              }
            ...
            if (state is LoadedNextTestState) {
              ...
              if(state.nextTestEntity.questionKy!=null && state.nextTestEntity.questionEn!=null){
                question = lan == ''
                ...
                question = lan == ''
                    ? state.nextTestEntity.question!
                    : lan == 'en'
                    ? (state.nextTestEntity.questionEn ?? state.nextTestEntity.question!)
                    : (state.nextTestEntity.questionKy ?? state.nextTestEntity.question!);
              }
